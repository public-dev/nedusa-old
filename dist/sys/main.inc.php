...
class Sys extends Database
{
        ...
        {
                $val = $this->user->signup($username, $pwd, $email);
        ...
        {
                echo "<div class='warning'><a>$message</a><button onclick=\"document.querySelector('.warning').parentNode.removeChild(document.querySelector('.warning'))\" class='fas fa-times'></button></div>";
        }
}
